  ...
  return (
    <div className="page">
      ...
      <div className="stats-row">
        ...
        <div className="stat-card">
          <div className="stat-value" style={{ fontSize: 13, paddingTop: 4, wordBreak: 'break-all' }}>
            <span className="text-muted text-sm">{data?.configPath ?? '—'}</span>
          </div>
      ...
      <div className="card">
        ...
        <div className="log-area">
          {(data?.recentLogs ?? []).length === 0
            ...
            : data!.recentLogs.map((l, i) => <div key={i} className="log-line">{l}</div>)
          }
        </div>
      </div>
    </div>
